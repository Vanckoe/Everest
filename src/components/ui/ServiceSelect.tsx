    ...
    <div className="w-full">
      <Listbox value={value} onChange={onChange}>
        <div className="relative">
          ...
          <Listbox.Options className="absolute bottom-full left-0 z-10 mt-2 max-h-[18.75rem] w-full overflow-auto rounded-xl bg-white py-1 shadow-xl ring-1 ring-black/5 focus:outline-none">
            {options.map(option => (
              <Listbox.Option
                key={option.title}
                value={option.title}
