      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                className="hidden md:flex size-14 min-w-14 bg-[#FE5B2C] rounded-full items-center justify-center
              ...
              <div
                className="flex size-20 min-w-20 md:size-14 md:min-w-14 bg-[#FE5B2C] rounded-full items-center justify-center
