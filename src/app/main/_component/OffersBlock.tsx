    ...
    <>
      ...
      >
        ...
        >
          {/* Left side */}
          <div
            className={`w-1/2 flex flex-col justify-between pl-[10rem] pt-[6.25rem] pr-[3.125rem] pb-[7.1875rem] transition-opacity duration-500 ${
          ...
          >
            ...
            <div className="flex flex-col items-start mt-3 mb-8">
              ...
              <div className="mt-2 w-[1.875rem] h-[0.125rem] bg-second"></div>
            </div>
            ...
            <div className="text-lg text-[#001f3f] max-w-md leading-relaxed mb-10 w-[19.6875rem]">
            ...
            >
              ...
              <div className="flex size-20 min-w-20 md:size-14 md:min-w-14 bg-second rounded-full items-center justify-center opacity-100 translate-x-0 group-hover:-mr-12 group-hover:opacity-0 group-hover:-translate-x-4 transition-all duration-300 ease-in-out">
                <RightIcon color="white" width="1.5rem" height="1.5rem" />
              </div>
            </button>
          </div>
          ...
          <div className="w-1/2 flex items-center justify-center p-5">
            <img
              ...
              className="w-[40.4375rem] h-[39.0625rem] rounded-[1.875rem] object-cover"
              draggable={false}
            />
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-center">
              <select className="w-[27.5rem] h-[3.875rem] border border-[#ddd] rounded-[0.625rem] px-4 mb-4">
              ...
              <input
                ...
                className="w-[27.5rem] h-[3.875rem] border border-[#ddd] rounded-[0.625rem] px-4 mb-4"
              />
              ...
              <textarea
                ...
                className="w-[27.5rem] h-[7.5rem] border border-[#ddd] rounded-[0.625rem] px-4 py-3 mb-4 resize-y"
              />
            </div>
            ...
            <div className="flex justify-center">
              <button className="w-[7.5rem] h-[3.75rem] bg-accent text-white rounded-[1.875rem] text-lg hover:bg-[#001a35] transition">
                Send
              </button>
            </div>
          </div>
