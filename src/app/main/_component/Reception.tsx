...
const Reception = () => {
  return (
    <section className="flex flex-col gap-20 md:flex-row md:items-center justify-between w-full bg-accent text-white py-32 md:py-24 px-12 md:px-24 md:h-[24.375rem]">
